...
def evaluate_problematic_v2():

    print("Evaluation on problematic questions with V2 pipeline")
    ...
    print("\n" + "=" * 60)
    print("RESULTS SUMMARY V2 PIPELINE")
    print("=" * 60)
    ...
    output_file = project_root / "data" / "problematic_results_v2.json"
