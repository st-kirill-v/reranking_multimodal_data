...
print("Loading Table Extractor (Qwen3-VL)...")
...
def compute_similarity(generated, expected):
    ...
    stop_words = {
        ...
        "were", "been", "has", "have", "had", "does", "do", "did",
...
def evaluate_problematic():
    print("=" * 60)
    print("Evaluation on problematic questions (F1 < 0.5 in previous run)")
    print("=" * 60)
    ...
    output_file = project_root / "data" / "problematic_results.json"
