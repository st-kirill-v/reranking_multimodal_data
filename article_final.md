...
**Рисунок 1.** Сравнение качества ответов для основных стратегий reranking. Adaptive Reranking добавлен как дополнительная balanced-конфигурация и не используется как основной proof для RQ1.
...
**Рисунок 2.** Распределение маршрутов Adaptive Reranking и показатели качества/latency по route.
...
**Рисунок 3.** Компромисс между качеством ответа и end-to-end latency для основных стратегий reranking.
